...
from main.helper import generate_report_csv_data , generate_csv_report_file, trigger_report_combined
...
class StoreViewSet(ModelViewSet):
    ...
    def trigger_report(self, request,pk):
        ...
        csv_data = []
        data = generate_report_csv_data(store)
        csv_data.append(data)
        generate_csv_report_file(report, csv_data)
